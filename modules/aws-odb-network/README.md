...
| <a name="input_aws_odb_network_kms_access"></a> [aws\_odb\_network\_kms\_access](#input\_aws\_odb\_network\_kms\_access)                                 | The configuration for KMS access from the ODB network                                                           | `string` | n/a | yes |
| <a name="input_aws_odb_network_kms_policy_document"></a> [aws\_odb\_network\_kms\_policy\_document](#input\_aws\_odb\_network\_kms\_policy\_document)    | The KMS policy document for Amazon S3 access from the ODB network                                               | `string` | `null` | no |
| <a name="input_aws_odb_network_sts_access"></a> [aws\_odb\_network\_sts\_access](#input\_aws\_odb\_network\_sts\_access)                                 | The configuration for STS access from the ODB network                                                           | `string` | n/a | yes |
| <a name="input_aws_odb_network_sts_policy_document"></a> [aws\_odb\_network\_sts\_policy\_document](#input\_aws\_odb\_network\_sts\_policy\_document)    | The STS policy document for Amazon STS access from the ODB network                                              | `string` | `null` | no |
